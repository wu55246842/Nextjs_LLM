	...
	return (
		<div className="hidden flex-col text-sm sm:flex">
			<div className="space-y-3 rounded-md bg-white bg-opacity-10 p-3">
				<Image src="/laowudiFish.png" width={150} height={50} alt={"Spotify Clone Logo"} />
			...
			<div className="mt-5 rounded-t bg-white bg-opacity-10 p-4 space-y-3">
				...
				<div className="flex flex-col justify-start space-y-5 text-gray-400 bg-gradient-to-b bg-gray-900 p-4 rounded-t text-left">
					<h1 className="text-xl">Create your first playlist</h1>
					<p className="text-base">It's easy,we'll help you</p>
					<button className="rounded-full px-4 py-2 text-sm font-bold transition duration-300 bg-white text-black hover:scale-105">
						Create playlist
					</button>
				</div>
