			...
			<div className="flex flex-row items-center space-x-2 px-5">
				...
				{session ? (
					...
					<div className="flex grap-5">
						<button
							className="rounded-full px-4 py-2 text-sm font-bold transition duration-300 text-gray-500 hover:text-white  hover:scale-105"
							onClick={(): void => router.push("/login")}>
							Sign  Up
						</button>
						<button
							className="rounded-full px-4 py-2 text-sm font-bold transition duration-300 bg-white text-black hover:bg-gray-300 hover:text-black  hover:scale-105"
							onClick={(): void => router.push("/login")}>
							Sign  In
						</button>
					</div>
