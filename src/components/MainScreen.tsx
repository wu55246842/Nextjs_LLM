...
import { FirstCard, FourthCard, SecondCard, SixthCard, ThirdCard } from "./CardDemo";
		...
		<div
			...
			{!playlistContent && !playlistID && !search && (
				<div className="flex flex-grow flex-col space-y-10 p-5">
					...
					<div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6">	
						<FirstCard/>
						<SecondCard />
						<ThirdCard />
						<FourthCard />
